                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <?php
                                $count = 0;
                                $sqlPro = mysqli_query($db, "SELECT * FROM `tags` ORDER BY id ASC");
                                while ($rowPro = mysqli_fetch_array($sqlPro))
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center><a style="width:80px;" class="btn btn-block bg-pink waves-effect" href="allTags.php?del=<?php echo $rowPro['id']; ?>"><i class="material-icons">delete</i></a></center>
                                        </td>
                                    </tr>
                                    <?php
                                }
